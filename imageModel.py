...
def newImgModel(inSize) :
    ...
    reShape = (int(inSize / 8), int(inSize / 8), 3)
    ...
    encoded = Dense(1024, activation='softmax')(d2)
    ...
    d5 = Dense(4800, activation= 'relu')(d4)
    ...
    conv19 = Conv2D(256, (3, 3), activation='relu', padding='same')(up1)
